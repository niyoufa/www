(function($) {
	$.fn.slide = function(options) {
		...
		$("<ul style='width:" + ($(settings.slideContainer).length * 15 + ($(settings.slideContainer).length - 1) * 25) + "px;margin-left:-" + ($(settings.slideContainer).length * 15 + (($(settings.slideContainer).length - 1) * 25)) / 2 + "px' class='navListBox'>" + navlist + "</ul>").appendTo(el.parent());
