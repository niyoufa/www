angular.module('starter.main_zhuangli_detail', [])
  .controller('MainZhuanLiDetailCtrl', function($scope,$state,$http) {
    console.log("专利详情");
    var detailInfo;
    ...
    //$http.post(basePath+'api/zldetail?id='+'QMNSLOUMQUSQ')
    //  .success(function(res){
    //    if(res.response.success==1){
    //      //成功
    //      detailInfo = res.response.data;
    //    }
    //  })
