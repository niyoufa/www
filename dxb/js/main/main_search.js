angular.module('starter.main_search', [])
  .controller('MainSearchCtrl', function($scope,$http,$state,$rootScope) {
    ...
    if(localStorage.getItem("isSearchKey") == "1"){
      ...
      document.getElementById("searchInfo").value=localStorage.getItem("hot_key");
      $scope.gosearch();
    }else{
    ...
    $scope.toCompany = function(company){
      company.basicinfo={};
      company.basicinfo.entname=company.name;
